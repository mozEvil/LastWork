...
public class InfoPanel100 extends JPanel {

    private final JLabel value;

    public InfoPanel100(String name) {
        setOpaque(false);
        ...
        layout.putConstraint(EAST, label, 80, WEST, label); // weight
        ...
        layout.putConstraint(EAST, value, 80, WEST, value); // weight
